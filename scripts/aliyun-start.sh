...
VOLCENGINE_ARK_API_KEY="${VOLCENGINE_ARK_API_KEY:-}"; VOLCENGINE_ARK_IMAGES_BASE_URL="${VOLCENGINE_ARK_IMAGES_BASE_URL:-https://ark.cn-beijing.volces.com/api/v3/images/generations}"; VOLCENGINE_ARK_SEEDREAM_IMAGE_MODEL="${VOLCENGINE_ARK_SEEDREAM_IMAGE_MODEL:-doubao-seedream-5-0-pro-260628}"
