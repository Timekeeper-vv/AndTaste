...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private static final Set<String> BACK_OFFICE_ROLES = Set.of("admin", "company_admin", "backoffice_user", "finance", "project_manager", "designer", "production", "logistics", "technician", "feeder");
