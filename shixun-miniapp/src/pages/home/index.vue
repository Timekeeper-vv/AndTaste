<template>
  <view class="page">
    ...
    <view class="conversation-promo" @tap="go('/pages/conversation-create/index')"><view class="conversation-promo-mark">聊</view><view><text class="conversation-promo-kicker">NEW · CONVERSATIONAL STUDIO</text><text class="conversation-promo-title">开始对话式创作</text><text class="conversation-promo-desc">像聊天一样回答几个问题，把灵感一步步做成产品、四视图和 3D 原型</text></view><text class="conversation-promo-arrow">›</text></view>
...
.selection-promo{display:flex;position:relative;z-index:1;align-items:center;gap:13rpx;margin-top:15rpx;padding:16rpx;border:1rpx solid #d6e0d5;border-radius:19rpx;background:linear-gradient(135deg,#f5f8f1,#fff7ee);box-shadow:0 9rpx 20rpx rgba(79,88,70,.06)}.selection-promo-mark{display:grid;place-items:center;flex:0 0 auto;width:52rpx;height:52rpx;border-radius:15rpx;background:#5f7e6f;color:#fff;font-family:"Songti SC","STSong",serif;font-size:29rpx;font-weight:800}.selection-promo>view:nth-child(2){display:flex;min-width:0;flex:1;flex-direction:column;gap:5rpx}.selection-promo-title{color:#4a4037;font-family:"Songti SC","STSong",serif;font-size:24rpx;font-weight:800}.selection-promo-desc{color:#82766b;font-size:15rpx;line-height:1.45}.selection-promo-arrow{color:#a3684f;font-size:31rpx}.selection-promo:active{opacity:.82}
.conversation-promo{display:flex;position:relative;z-index:1;align-items:center;gap:13rpx;margin-top:15rpx;padding:18rpx 16rpx;border:1rpx solid #c8d9cc;border-radius:20rpx;background:linear-gradient(135deg,#e7f1e8,#fff7ed 72%);box-shadow:0 11rpx 24rpx rgba(79,99,81,.1)}.conversation-promo-mark{display:grid;place-items:center;flex:0 0 auto;width:58rpx;height:58rpx;border:1rpx solid #789884;border-radius:17rpx;background:#5f7e6f;color:#fff;font-family:"Songti SC","STSong",serif;font-size:28rpx;font-weight:800}.conversation-promo>view:nth-child(2){display:flex;min-width:0;flex:1;flex-direction:column;gap:5rpx}.conversation-promo-kicker{color:#668473;font-size:13rpx;font-weight:900;letter-spacing:1.5rpx}.conversation-promo-title{color:#3f473e;font-family:"Songti SC","STSong",serif;font-size:28rpx;font-weight:800}.conversation-promo-desc{color:#7d756c;font-size:15rpx;line-height:1.45}.conversation-promo-arrow{color:#a3684f;font-size:34rpx}.conversation-promo:active{opacity:.82}
</style>
<style scoped lang="scss">
