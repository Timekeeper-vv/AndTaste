<template>
  <view class="page">
    ...
    <view class="profile-hero">
      <image class="seal-avatar" src="/static/ui-design/brand-logo.png" mode="scaleToFill" />
...
<style scoped lang="scss">
.seal-avatar{display:block;flex:none;border-radius:0;background:transparent}
</style>
