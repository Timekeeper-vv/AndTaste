...
export type PageName =
  | 'dashboard' | 'approvalCenter' | 'studio' | 'creative2d' | 'creative3d' | 'creativeReview' | 'chain' | 'chainMarketing' | 'chainNewProduct' | 'chainPriceAdjust' | 'marketDemand' | 'marketPromotion' | 'marketEcommerceNewProduct' | 'marketShooting' | 'marketProductCopy' | 'projectDemand' | 'projectInitiation' | 'projectInquiry' | 'hrManagement' | 'hrNewProductIncentive' | 'hrResignation' | 'hrTraining' | 'hrHolidayOvertime' | 'hrTransfer' | 'hrPolicyApproval' | 'hrRegularization' | 'hrRecruitment' | 'attendanceManagement' | 'attendanceCardRepair' | 'attendanceLeave' | 'attendanceBusinessTrip' | 'attendanceOutgoing' | 'supplierList' | 'sampleWorkOrders' | 'finance' | 'financeAssetScrap' | 'financePublicPayment' | 'financePettyCash' | 'financePersonalExpense' | 'financePromotionApproval' | 'financeSeal' | 'financePettyCashRepay' | 'financeTravel' | 'financeInvoice' | 'financeSpecialExpense' | 'financePettyCashWriteoff' | 'warehouseLogistics' | 'marketing' | 'businessAi' | 'commercialMvp' | 'scaleUp' | 'createProductionProject' | 'production' | 'sampleApplication' | 'sampleProduction' | 'bulkProduction' | 'marketplace' | 'orders' | 'logistics' | 'warehouse' | 'designers'
