    ...
    <section v-if="rows.length" class="request-list">
      <article v-for="r in rows" :key="r.id" class="request-card">
        ...
        <div class="body">
          ...
          <footer>
            <a v-if="r.assetId" :href="`/api/creative/ai/assets/${r.assetId}/model-content`" target="_blank" rel="noopener">打开3D模型</a>
