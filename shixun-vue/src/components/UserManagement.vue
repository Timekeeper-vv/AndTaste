...
const roleOptions: Array<{ value: Role; label: string }> = [
  ...
  { value: 'backoffice_user', label: '普通后台用户' },
  { value: 'finance',    label: '财务' },
  { value: 'project_manager', label: '项目经理' },
  { value: 'designer',   label: '设计师' },
  { value: 'production', label: '生产' },
  { value: 'logistics',  label: '物流' },
  { value: 'technician', label: '审批主管（旧）' },
  { value: 'feeder',     label: '员工（旧）' },
  { value: 'user',       label: 'C端用户' },
]
const roleLabelMap: Record<Role, string> = { admin: '超级管理员', company_admin: '后台管理员', backoffice_user: '普通后台用户', finance: '财务', project_manager: '项目经理', designer: '设计师', production: '生产', logistics: '物流', technician: '审批主管（旧）', feeder: '员工（旧）', user: 'C端用户' }
const roleBadgeClass: Record<Role, string> = { admin: 'badge-admin', company_admin: 'badge-approver', backoffice_user: 'badge-employee', finance: 'badge-employee', project_manager: 'badge-approver', designer: 'badge-designer', production: 'badge-approver', logistics: 'badge-employee', technician: 'badge-approver', feeder: 'badge-employee', user: 'badge-user' }
