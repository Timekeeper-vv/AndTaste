...
<template>
  <div class="commercial-page">
    <section class="hero">
      <div><span>COMMERCIAL WORKFLOW</span><h1>商品化与代销审核</h1><p>处理用户报价、打样、渠道代销和驳回后的专业指导。专业指导完成后，用户会上传本地修改图并重新进入原申请的审核流程。</p></div>
