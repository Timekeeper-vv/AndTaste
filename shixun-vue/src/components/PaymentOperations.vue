...
async function load() {
  loading.value = true
  try {
    const [orderRows, exceptionRows, billRows] = await Promise.all([
...
<template>
  <div class="payment-page">
    <section class="payment-hero">
      <div><span>PAYMENT OPERATIONS</span><h1>支付运营</h1><p>管理充值与打样费订单、人工收款核验、退款和微信账单对账。到账状态只以微信官方回调或后台对账为准。</p></div>
