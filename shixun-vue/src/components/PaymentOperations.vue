...
.product-no{display:inline-block;padding:4px 7px;border:1px solid #c9dfce;border-radius:6px;color:#2f6844;background:#eef8f0;font-size:12px;letter-spacing:.02em}
</style>
